...
export const MY_STORE_MOCK: Store = {
  ...
  breakTimeHours: '10:00 - 22:00 (연중무휴)',
  rating: 5.0,
  reviewCount: 88,
...
export const INITIAL_STORES: Store[] = [
  ...
  },
  {
    id: 'store-6',
    ownerName: '정편의 사장님',
    storeName: 'CU 양산대로점 (편의점)',
    category: 'CONVENIENCE',
    categoryName: '편의점',
    address: '경남 양산시 양산대로 830',
    lat: 35.35895,
    lng: 129.04145,
    phone: '055-383-1212',
    isVerified: true,
