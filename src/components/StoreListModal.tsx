...
import { Store, ExchangeItem, MenuTestCampaign, KAKAO_OPEN_CHAT_URL } from '../types/trade';
      ...
      <div className="relative w-full h-full sm:h-[90vh] sm:max-w-4xl bg-white sm:rounded-3xl shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-3 sm:p-5 space-y-4 bg-slate-100/80">
          ...
          <a
            ...
            className="p-3 bg-gradient-to-r from-amber-50 via-yellow-50 to-amber-100 border border-yellow-300/80 rounded-2xl flex items-center justify-between gap-2 shadow-2xs hover:border-yellow-400 transition-all group"
          >
            <div className="flex items-center gap-2.5 min-w-0">
              <div className="w-8 h-8 rounded-xl bg-yellow-400 text-yellow-950 flex items-center justify-center font-black text-sm flex-shrink-0 group-hover:scale-105 transition-transform shadow-2xs">
                💬
              </div>
              <div className="min-w-0">
                <p className="text-xs font-black text-yellow-950 truncate">
                  이웃 사장님들과 빠른 질문 & 소통이 필요하신가요?
                </p>
                <p className="text-[10px] text-yellow-900/80 truncate">
                  트레이드미 사장님 공식 카카오톡 단톡방에서 함께 소통해보세요!
                </p>
              </div>
            </div>
            <span className="px-2.5 py-1 bg-yellow-400 hover:bg-yellow-300 text-yellow-950 font-black text-[11px] rounded-lg flex items-center gap-0.5 flex-shrink-0 whitespace-nowrap shadow-2xs">
              <span>단톡방 가기</span>
          ...
          {filteredStores.length === 0 ? (
            <div className="py-14 text-center space-y-3.5 bg-white rounded-3xl border border-gray-200 p-6 shadow-sm">
              <div className="w-14 h-14 rounded-full bg-orange-50 flex items-center justify-center text-orange-500 text-2xl mx-auto shadow-inner">
                🔍
              </div>
              <h3 className="font-extrabold text-base text-gray-800 break-keep">
                우리 동네에 아직 가맹점이 보이지 않나요?
              </h3>
              <p className="text-xs text-gray-500 leading-relaxed max-w-sm mx-auto break-keep">
                초기 오픈 지역이거나 검색 조건이 좁을 수 있습니다.<br />
                <strong>카카오톡 사장님 소통방</strong>에서 함께할 이웃 매장을 찾거나 질문을 남겨보세요!
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-2 pt-1">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 px-4 py-2.5 bg-yellow-300 hover:bg-yellow-400 text-yellow-950 font-black text-xs rounded-xl shadow-xs transition-all active:scale-95 cursor-pointer"
                >
                  <span>💬 카카오톡 사장님 단톡방 입장하기</span>
                </a>
                <button
                  type="button"
                  onClick={resetFilters}
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 px-4 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 font-extrabold text-xs rounded-xl transition-all active:scale-95 cursor-pointer"
                >
